...
var _self = \"undefined\" != typeof window ? window : \"undefined\" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope ? self : {},
    Prism = function(u) {
        ...
        var _ = {
            ...
            plugins: {},
            highlightAll: async function(e, r) {
                await _.highlightAllUnder(document, e, r)
            },
            highlightAllUnder: async function(e, r, n) {
                var t = {
                    callback: n,
                    selector: 'pre' //'code[class*=\"language-\"], [class*=\"language-\"] code, code[class*=\"lang-\"], [class*=\"lang-\"] code'
                };
                await _.hooks.run(\"before-highlightall\", t);
                for (var a, i = e.querySelectorAll(t.selector), o = 0; a = i[o++];) _.highlightElement(a, !0 === r, t.callback)
            },
            highlightElement: async function(e, r, n) {
                var t = async function(e) {
                        for (; e && !c.test(e.className);) e = e.parentNode;
                        return e ? (e.className.match(c) || [, \"none\"])[1].toLowerCase() : \"none\"
                    }(e),
                    a = await _.languages[e.lang];
                let lang = await e.lang
                e.className = e.className.replace(c, \"\").replace(/\\s+/g, \" \") + \" language-\" + lang; //t;
                var i = e.parentNode;
                i && \"pre\" === i.nodeName.toLowerCase() && (i.className = i.className.replace(c, \"\").replace(/\\s+/g, \" \") + \" language-\" + lang);// t);
                var o = {
                    element: e,
                    language: lang,
                    grammar: a,
                ...
                async function l(e) {
                    o.highlightedCode = await e, _.hooks.run(\"before-insert\", o), o.element.innerHTML = o.highlightedCode, _.hooks.run(\"after-highlight\", o), _.hooks.run(\"complete\", o), n && n.call(o.element)
                }
            ...
            highlight: async function(e, r, n) {
                var t = {
                    code: e,
                    grammar: r,
                    language: n
                };
                return _.hooks.run(\"before-tokenize\", t), t.tokens = await _.tokenize(t.code, t.grammar), _.hooks.run(\"after-tokenize\", t), L.stringify(_.util.encode(t.tokens), t.language)
            },
...
Prism.languages.mizar = {
    comment: /::.+/,
    keyword: /@proof\\b|\\b(?:according|aggregate|all|and|antonym|are|as|associativity|assume|asymmetry|attr|be|begin|being|by|canceled|case|cases|clusters?|coherence|commutativity|compatibility|connectedness|consider|consistency|constructors|contradiction|correctness|def|deffunc|define|definitions?|defpred|doo|does|equals|end|environ|ex|exactly|existence|for|from|func|given|hence|hereby|holds|idempotence|identity|iff?|implies|involutiveness|irreflexivity|is|it|let|means|mode|non|not|notations?|now|of|or|otherwise|over|per|pred|prefix|projectivity|proof|provided|qua|reconsider|redefine|reduce|reducibility|reflexivity|registrations?|requirements|reserve|sch|schemes?|section|selector|set|sethood|st|struct|such|suppose|symmetry|synonym|take|that|the|then|theorems?|thesis|thus|to|transitivity|uniqueness|vocabular(?:y|ies)|when|where|with|wrt)\\b/,
    parameter: {
        pattern: /\\$(?:10|\\d)/,
        alias: \"variable\"
    },
